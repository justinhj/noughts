...
Rewrite Board to use two loops to make the squares instead of hardcoding them. [X] (used fp-ts)

Use fp-ts https://github.com/gcanti/fp-ts [X] (array, range)
